...
wget https://github.com/BirjuVachhani/git_watcher/releases/download/0.1.0/gitwatcher-linux-amd64.tar.gz -O "$(install_dir)/gitwatcher-linux-amd64.tar.gz"

# Extract the GitWatcher binary
echo "Extracting GitWatcher binary"
tar -xzf "$(install_dir)/gitwatcher-linux-amd64.tar.gz" -C "$(install_dir)"
